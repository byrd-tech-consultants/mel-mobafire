...
class BBCodePreprocessor:
    ...
    def remove_tabs(self, content):
        """Remove all tab characters, preserving line structure"""
    ...
    def process_file(self, input_path, output_path, clean_whitespace=True, remove_tabs=False):
...
Examples:
  ...
  python bbcode_preprocessor.py -t input.bbcode output.bbcode  # remove tabs
  python bbcode_preprocessor.py --stats input.bbcode output.bbcode  # show stats
    ...
    parser.add_argument('-t', '--remove-tabs', action='store_true',
                       help='Remove all tab characters from output')
