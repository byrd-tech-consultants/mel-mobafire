					...
					[col width="100%"]
						...
						[responsive]
							[row]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											// Left side - matchup info
											[col width="75%" min-width="220px"]
												// Matchup difficulty
												[size=4][color=#FFFF99][b]Matchup Difficulty[/b][/color][/size]
												[size=1][color=#FFFF99] [/color][/size]
												
												[table border="2px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%" style="max-width: 250px; min-width: 180px; border-collapse: collapse;"]
													[tr]
														[td bgcolor="#00ff00" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#33cc00" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#66aa00" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#99aa00" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#ccaa00" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#333333" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#333333" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#333333" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#333333" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#333333" width="10%" height="20px" style="border: 0;"][/td]
												...
												// Summoners and Build on same line when space allows
												[responsive]
													[row]
														// Summoners
											...
											// Right side - champion portrait
											[col width="25%" min-width="80px"]
												[center][icon=classic ahri size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						// Strategy section - full width responsive text
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											[col width="75%" min-width="220px"]
												...
												[table border="2px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%" style="max-width: 250px; min-width: 180px; border-collapse: collapse;"]
													[tr]
														...
														[td bgcolor="#99aa00" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#ccaa00" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#ffaa00" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#ff6600" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#333333" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#333333" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#333333" width="10%" height="20px" style="border: 0;"][/td]
													[/tr]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic akali size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											[col width="75%" min-width="220px"]
												...
												[table border="2px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%" style="max-width: 250px; min-width: 180px; border-collapse: collapse;"]
													[tr]
														...
														[td bgcolor="#ffaa00" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#ff6600" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#ff3300" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#333333" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#333333" width="10%" height="20px" style="border: 0;"][/td]
													[/tr]
												[/table]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic akshan size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]This lane is definitely not Mel-favored. Akshan wins almost every lane in the game but he is completely useless in teamfights later into the game. Once again, play from range and try to land your free poke from distance. DO NOT go too far aware from your tower. All it takes is one good swing off the wall and Akshan will claim half of your HP instantly. Twice and you are dead. We need to shove waves, ping his roams and follow when possible, and pray that our team will respect his strength. The sad reality of this lane is that we have minimal impact to do anything. We need to wait for our jungler to gank or for Akshan to make a mistake before we can capitalize.[/color]
								[/td]
							[/tr]
						[/table]
					[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic anivia size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic annie size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic aurelion sol size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic aurora size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											[col width="75%" min-width="220px"]
												...
												[table border="2px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%" style="max-width: 250px; min-width: 180px; border-collapse: collapse;"]
													[tr]
														...
														[td bgcolor="#ff6600" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#ff3300" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#ff0000" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#333333" width="10%" height="20px" style="border: 0;"][/td]
													[/tr]
												[/table]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic azir size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic cassiopeia size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic corki size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic diana size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic ekko size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic ezreal size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic fizz size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic galio size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic garen size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Likely, he will run second wind + Doran's shield making him almost impossible to kill. Clear the wave and roam. Interacting in this lane is almost pointless after he gets some health/MR. Keep in mind that any damage will reset his passive timer, preventing him from gaining. After level 9, his passive healing becomes even stronger. This lane is won by affecting the map and outscaling. You have too much range to take damage from him, even if he tries to flash on you. You get outscaled here though and NEED to gain a lead somewhere else on the map. Max E in this lane.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic gragas size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Not played mid very much, and for good reason. Gragas can use his Q to do some poke to you and has some sustain with his passive. Besides this, he cannot his you with the rest of his spells. Even his ultimate is too close range to knock you into him if you play from the max-range of your spells. HOWEVER, he can E+Flash combo you to catch you offguard. If he does this, press your W while he is mid animation. This will allow you to block the inital damage and you can usually just walk away afterwards. Max E in this lane.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic heimerdinger size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic hwei size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Hwei has been hit with nerfs so many times and is now just a bad champion. He does very little damage. When he uses his lava river, be cautious of him using his E+E(jaws) to pull you into the river and proccing his passive. You have more range and your Q can be cast from behind minions unlike his best poking spell Q+Q (fireball). Free lane here, poke him out and look to kill once he is low. This lane is super winnable and you can look to win the game through annihilating him in lane and carrying teamfights.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic irelia size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic jayce size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic kai'sa size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Bully her out of lane. Spam Q and E on her. If she tries to E and run forward at you, just backup and block her Q with your W. Max Q here.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic karma size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Very strong lane bully and we need to be very careful. If we overstep, she can use her Inner Binding to land a free root on us. If she uses her empowered Q, we CAN block it, but only if it lands directly on us. If it explodes on the ground nearby or hits a minion, it won't reflect from our W. As always, we play from range here. Save your E until he is in closer quarters (it's too easy to dodge if she is far away). Do not use your W on her root. Only use it on her Q. We outscale in his lane. We will lose lane prio most likely but can oustcale.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic kassadin size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic katarina size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Katarina is not a hard champion in lane. For some reason, it always seems like Katarina will randomly roam bot and get a double kill. Ever. Single. Game. Shove waves and poke Katarina out. If she uses her Bouncing Dagger, run forward such that she cannot get her passive damage from the blade. Continue to trade and you can almost always in the trades, especially if you W any of her damage. Keep in mind that when you use your W, it will reflect many of the daggers from her ultimate over the 0.75 seconds that your reflection is active. Always keep track of her movement and ping her roam timers to your team. If she does not start Doran's Shield this lane is super free. She should be going down 50cs by 14 minutes with several plates lost.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic kayle size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Easy lane. Abuse her from range. She is only a threat after 6. If we dodge her Q she is very weak. Don't use your E from max range, only when she attempts to get closer. Abuse her before she gets her range at level 6. You get outscaled against a good Kayle.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic leblanc size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic lissandra size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic lucian size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Probably the hardest ADC for us to play against in midlane. His Q is not reflectable and we don't have any great reflections here, outside of his ultimate if he uses it poorly or reflecting 3 of his auto attacks. I recommend playing safe in this lane. We need to avoid him poking us with his Q through minion I.E, do not let him line it up properly. Do not use your E carelessly as he can easily dash out of the way. Use your Q for poke and focus on shoving the wave/suriving. This is a very skill-dependent matchup.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic lux size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic malphite size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic malzahar size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic morgana size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Morgana has strong waveclear with her W. She can avoid your E cc with her blackshield. Poke her down with Q, and focus on clearing the wave such that you aren't forced to spend time CSing under tower. Reflect her Q when needed. Very easy lane though we probably can't solo kill her.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic naafiri size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Naafiri suffers from a lack of range. Do not use your E unless she engages and uses her invulnerability spell first. Poke her with your Q from range and focus on dodging her daggers. She is a much stronger skirmisher than us but we will heavility outscale. Max E in this lane and ping her roams around the map.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic neeko size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic orianna size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]This lane sucks because we have nothing to reflect. While we do have longer range, it's not by much. Orianna has more damage, stronger waveclear, a better ultimate, and more DPS. play from range and focus on dodging her ball Q+W combo. Call for your jungler when you are really struggling. Often times, if you are both low and the Orianna looks to Q her ball onto you, you can Flash+E combo, dodging her spells and if you do it quick enough, she doesn't have time to react. The whole lane revolves around her ball. If it is not on top of you, she cannot cast her spells. Sadly, she can move it every 3ish seconds with Q and we need to play around this timer. Consider banning her.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic pantheon size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic qiyana size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]This is one of the hardest assassin matchups. Two key things: We CAN reflect her Qs and DO NOT stand near walls. If she ever gets a full combo on us we are dead. Stand back and use your spells to clear the wave. Use your reflection if she dashes on top of you. In teamifghts, you can reflect her ultimate with your W. This is absolutely massive and can be used to turn fights completely, especially in the river. Do not throw out your E until she is too close to you to react. She will just dash to dodge it. Max E in this lane.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic rumble size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Rumble has no high-range spells to touch you. Poke from range and stand behind minions to avoid his electro harpoon. Do not let him shove the wave for free. Max E in this lane.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic swain size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Swain is dangerous if he can manage to stick ontop of us in melee range. We have better range and can lay down good poke. Avoid getting hit by his E, which we can reflect with our W. We cannot reflect his Q. Very simple lane, keep distance, dodge spells, and you should be just fine. Max E in this lane.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic sylas size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic smolder size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Smolder sucks as a midlaner now. He is very squishy and will lose every trade if you land spells. Poke him out with your Q and E. Max Q in this lane.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic syndra size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Syndra is equally as hard as Orianna and the lanes are very similar. We can use our W to reflect Syndra W and R, but we cannot reflect her other spells (including her E scatter). This is a skill matchup but we need to be slightly better and hit slightly more spells than the Syndra since we do less damage. Dodge as many of her Qs as you can. Consider purchasing boots early for easier dodging of her spells. If she guys magic pen items (shadowflame, stormsurge), invest in a null-magic mantle, only upgrading to a Banshee's Veil later in the game. The mage with the better movement will win in this lane.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic taliyah size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]Taliyah is a very strange champion. For starters, all of her spells are dodgable and if you are good enough, can easily win the lane. On the other hand, her Seismic Shove is nearly as long-range as our spells and can easily catch us out of position. If we do get Seismic Shoved, immediately press your W to avoid taking the damage from the rocks. You should never be dieing to a Taliyah 1:1. You can abuse her from range and you SHOULD dodge most of her Seismic Shoves. Be aware of her waveclear and roam. Ensure that you are constantly pinging to your team when she is moving. Consider purchasing boots early for easier dodging of her spells.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic talon size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											[col width="75%" min-width="220px"]
												...
												[table border="2px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%" style="max-width: 250px; min-width: 180px; border-collapse: collapse;"]
													[tr]
														...
														[td bgcolor="#ff3300" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#ff0000" width="10%" height="20px" style="border: 0;"][/td]
														[td bgcolor="#cc0000" width="10%" height="20px" style="border: 0;"][/td]
													[/tr]
												[/table]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic tristana size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic tryndamere size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic twisted fate size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic veigar size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]We cannot reflect Veigar's W. Lane phase is simple, stay behind minions. He has very good gank setup with his cage and we need to be tracking the enemy junglers position constantly, especially if we don't have flash off cooldown. Always look to reflect his ultimate if you are within his lethal range. DO NOT ever walk into his cage wall, you cannot reflect it and it is better to trapped inside than stunned. Max Q in this lane.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic vel'koz size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]The best Vel'Koz players make you want to quit the game. He does a shocking amount of damage, but is super squishy and vulnerable to ganks. If you see that the Vel is using all of his W on the wave, this is a good opportunity to trade with him. Keep in mind though, if you reflect his Q, the interaction is strange and often will get blocked by a minion before hitting him. Clear waves here and poke him with your Q. Max Q in this lane.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic vex size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]We can reflect all of Vex's ability except for her shield. In order to reflect her E, we must cast our reflection before it hits the ground, this is super unlikely. Focus on reflecting her Q and Ult. Do not let her push the wave for free. We have better poke, especially if you can manage to dodge her Q since the ability travels slowly at first. This is a Mel favored lane. Consider investing in boots early for an easier time dodging her spells. When the bar under Vex's HP is full, this means her next ability is going to fear you. Be ready for the potential flash W combo from Vex, guaranteeing that she can fear you and enabling her to hit the rest of her spells with ease.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
								...
								[col width="100%" min-width="280px"]
									[responsive]
										[row align-items="flex-start"]
											...
											[col width="25%" min-width="80px"]
												[center][icon=classic viktor size=125][/center]
											[/col]
										[/row]
									[/responsive]
								[/col]
						...
						[table bgcolor="#654321" border="3px solid #FF8C00" border-radius="8px" cellpadding="0" cellspacing="0" width="100%"]
							[tr]
								[td padding="15px 12px"]
									[size=3][color=#FFFF99][b]Strategy[/b][/color][/size]
									[size=1][color=#FFFF99] [/color][/size]
									[color=#FFFF99]We can reflect Viktor's E with our shield. We have two spells that can hit him from far range, he only has 1. We will win the poking war if we don't get close enough for him to use his Q. Purchase boots if the viktor has already bought them ASAP. This lane can be quite boring as we both have a lot of range and are likely to just reset if either champion gets low enough. Max Q in this lane.[/color]
								[/td]
							[/tr]
						[/table]
						[/spoiler]
